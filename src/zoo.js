...
function increasePrices(percentage) {
  ...
  prices.Adult = Math.round(100 * (prices.Adult * (1 + percent))) / 100;
  prices.Child = Math.round(100 * (prices.Child * (1 + percent))) / 100;
  prices.Senior = Math.round(100 * (prices.Senior * (1 + percent))) / 100;
}
